...
<div class="expl-box-fi114" ng-fi-text="   Acum trebuie sa te folosești de încă un bloc care întoarce tancul. Tu trebuie să-ți conduci tancul în punctul care trebuie urmând drumul fără sa te duci pe iarbă."></div>

<script src="fisiere/lectii/algoritmul/generareMapa.js"></script>
<script>pagina114();</script>
