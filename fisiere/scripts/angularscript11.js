...
var counterSursa=1;
   ...
   var href1=$location.absUrl();
       href1=href1.charAt(href1.length-3);
        if (href1=="2")
         $scope.codeSrc="fisiere/expresiiAritmetice/expresieAritmetica2.html";
          else if(href1=="3"){
             $scope.codeSrc="fisiere/operatoriRelationali/operatoriRelationali2.html";
          } else if(href1=="4"){
             $scope.codeSrc="fisiere/expresiiLogice/expresiiLogice2.html";
          }
     $timeout( function(){
         if (href1=="2")
         $scope.codeSrc="fisiere/expresiiAritmetice/expresieAritmetica1.html";
          else if(href1=="3"){
             $scope.codeSrc="fisiere/operatoriRelationali/operatoriRelationali1.html";
          } else if(href1=="4"){
             $scope.codeSrc="fisiere/expresiiLogice/expresiiLogice1.html";
          }
    ...
    numarSurse=5;
        ...
        href2="fisiere/expresiiAritmetice/expresieAritmetica";
    } else if(href1=="3"){
        numarSurse=6;

        href2="fisiere/operatoriRelationali/operatoriRelationali";
    } else if (href1=="4"){
      numarSurse=2;

      href2="fisiere/expresiiLogice/expresiiLogice";
    }
...
var numarIntermediar=0;
  ...
  $http({
  method: 'POST',
  url: '/fisiere/generareIntrebari.php',
