...
target=i*10+j;
 ...
 $("#id-"+23).attr('src','paginaUtilizator/assets/images/curba3.png');
     $("#id-"+33).attr('src','paginaUtilizator/assets/images/road_intersectie.png');
       ...
       $("#id-"+24).attr('src','paginaUtilizator/assets/images/road.png');
       $("#id-"+25).attr('src','paginaUtilizator/assets/images/curba.png');
       $("#id-"+36).attr('src','paginaUtilizator/assets/images/road_target.png');
}