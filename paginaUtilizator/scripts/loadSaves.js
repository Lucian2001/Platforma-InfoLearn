...
if (vectorIds[i]==0){
   ok=false;
    ...
    href="http://infolearnchestie-com.stackstaging.com/index.php?paginaUtilizator=inceput"+href;
...
function submenuhref(id){
    var href1="http://infolearnchestie-com.stackstaging.com/index.php?paginaUtilizator=inceput#";
    href1=href1+id;
    return href1;
}
