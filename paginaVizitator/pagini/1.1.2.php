...
<script src="paginaVizitator/scripts/generareMapa.js"></script>
...
target1=generareTinta(locatiiValide,33,37,3);
    $("#id-"+target1).attr('src','paginaVizitator/assets/images/road_target.png');
...
$(document).ready(function(){
   ...
   // $("#id:35").attr("src","paginaVizitator/assets/images/road_target");
// $("#id-35").attr('id', 'target');


    $("#object1").attr('src','paginaVizitator/assets/images/'+tanc+'.png');
$("#object1").show();
