var x="",y="";var nr=0;var  pasi=0;var urlNou=""; var capatUrl;var tancId; var  eroareDegree;   var Id;
$("#butonsmecher").click(function(){
y="";
nr=0;

setTimeout(function (){
 if (window.location.href!="http://infolearnchestie-com.stackstaging.com/index.php?paginaVizitator=inceput#/1/1#2" || window.location.href!="http://infolearnchestie-com.stackstaging.com/index.php?paginaVizitator=inceput#/1/1#3"|| window.location.href!="http://infolearnchestie-com.stackstaging.com/index.php?paginaVizitator=inceput#/1/1#4"){
...
urlNou="http://infolearnchestie-com.stackstaging.com/index.php?paginaVizitator=inceput#"+urlNou;

  window.location.replace(urlNou);

    if (window.location.href!="http://infolearnchestie-com.stackstaging.com/index.php?paginaVizitator=inceput#/1/1#1"){
...
offset1 = target.offset();
          if (i==-1){
            ...
            $.ajax({   type:"POST",
                     url:"paginaVizitator/testHttp.php",
                     data:"Id=" + Id ,
        ...
        showthings(); 
        if (window.location.href=="http://infolearnchestie-com.stackstaging.com/index.php?paginaVizitator=inceput#/1/1#2" ){ 
   ...
   bottom: "+="+z1,
    ...
    function rotate1() {
     ...
     tancId=(Math.floor(tancId/10));
      $.ajax({   type:"POST",
                     url:"paginaVizitator/uploadTancId.php",
                     data:"Id=" + tancId ,
                  success:function(result)
                     {
