...
<body>
     <div id="myaccount" data-toggle="modal" data-target="#myModal" style="width:10%;">
            <p   font-weight= "normal;" id="login-text">Profesor</p>
...
<div id="panel2">
    ...
    <script src="pagini/scripts/paginaProfesor.js"></script>
